    ...
    <div class="container mx-auto px-6">
      <div class="max-w-6xl mx-auto">
        <div class="grid lg:grid-cols-2 gap-16">
          ...
          >
            <h2 class="text-3xl md:text-5xl font-display mb-8 gold-gradient">
            ...
            <div class="grid gap-6">
              <button
                ...
                class="w-full text-left bg-white/5 border p-6 rounded-2xl transition-all group relative overflow-hidden cursor-pointer"
                :class="
                  selectedIdx === idx
              ...
              >
                <div
                  ...
                  class="absolute left-0 top-0 bottom-0 w-1 bg-gold"
                ></div>
                <div class="flex items-center justify-between gap-4 w-full">
                  <div>
                    ...
                    <div class="flex items-center gap-2 text-gold-light">
                      <MapPin :size="16" />
                      <span>{{ slot.name }}</span>
                    </div>
                  </div>
                  <div
                    class="flex items-center gap-2 text-gray-400 text-sm bg-white/5 px-4 py-2 rounded-xl border border-white/5"
                  >
          ...
          <div
            ...
            class="relative aspect-square md:aspect-video lg:aspect-square rounded-2xl overflow-hidden border border-gold/20 z-0"
          >
            <div
              ref="mapContainer"
            ...
            >
              <div
                class="bg-black/80 backdrop-blur-md border border-gold/20 p-4 rounded-xl"
              >
                <p
                  class="text-gold text-xs font-bold uppercase tracking-widest mb-1"
                >
